...
interface KodeinFragmentActivityInitializer : KodeinComponentInitializer<FragmentActivity> {
...
abstract class KodeinFragmentActivity : FragmentActivity(), KodeinFragmentActivityInitializer {
